...
Installation:
Unzip the folder, then copy the information from script.yaml file into the /homeassistant/scripts.yaml file. Place the remaining unzipped files from the "getAir" folder in the /homeassistant/custom_components folder from your Home Assistant machine.
